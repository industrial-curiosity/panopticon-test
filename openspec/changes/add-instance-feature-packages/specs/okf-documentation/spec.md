...
Root and nested `index.md` files SHALL provide progressive-disclosure listings,
and any `log.md` SHALL use date-grouped update entries. Test-only Markdown
fixtures SHALL live outside the documentation bundle.
