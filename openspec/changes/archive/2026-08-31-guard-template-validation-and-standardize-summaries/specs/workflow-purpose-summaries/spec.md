...
The template repository SHALL include deterministic tests that inventory shipped
step-bearing workflow jobs and verify their required purpose preambles.
