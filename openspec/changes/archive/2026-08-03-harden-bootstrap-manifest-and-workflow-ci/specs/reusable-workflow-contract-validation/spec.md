# Reusable Workflow Contract Validation Delta
...
validation SHALL report every dot-form `inputs.<name>` or `secrets.<name>`
expression reference that lacks a declaration in the matching
